...
const Mission = () => {
  return (
    <div className="missionz">
      <section>
        <div class="custom-shape-divider-bottom-1681346366">
          <svg
            data-name="Layer 1"
        ...
        <div className="mission-text">
          ...
          <div className="mission-cont">
            <div className="mission-content">
              <div className="missionflyer">
                <img src="rider.avif" alt="" />
                <h3>Become a rider</h3>
                <p>
                  Be your own boss! Enjoy flexibility, freedom and competitive
                  earnings by delivering with Usl.
                </p>
              </div>
              <a href="#">
            ...
            <div className="mission-content">
              <div className="missionflyer">
                <img src="partner.avif" alt="" />
                <h3>Become a partner</h3>
                <p>
                  Grow with Usl! Our technology and user base can help you boost
